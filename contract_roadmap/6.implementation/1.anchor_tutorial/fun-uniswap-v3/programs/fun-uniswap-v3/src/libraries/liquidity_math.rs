...
pub fn get_liquidity_from_amount_0(
    ...
    //output parameters
    msg!("calculate liuqidity from amount0");
...
pub fn get_liquidity_from_single_amount_0(
    ...
    //output parameters
    msg!("sqrt_ratio_x64: {}", sqrt_ratio_x64);
    msg!("sqrt_ratio_a_x64: {}", sqrt_ratio_a_x64);
    msg!("sqrt_ratio_b_x64: {}", sqrt_ratio_b_x64);
    msg!("amount_0: {}", amount_0);
...
pub fn get_delta_amount_0_unsigned(
    ...
    println!("calculate delta amount0");
...
pub fn get_delta_amount_1_unsigned(
    ...
    //example:"Example: 0.1 becomes 1, 1.7 becomes 2"
    let result = if round_up {
    ...
    println!("U256::from(liquidity): {}", U256::from(liquidity));
    println!("U256::from(sqrt_ratio_b_x64 - sqrt_ratio_a_x64): {}", U256::from(sqrt_ratio_b_x64 - sqrt_ratio_a_x64));
    println!("U256::from(fixed_point_64::Q64): {}", U256::from(fixed_point_64::Q64));
...
pub fn get_delta_amounts_signed(
    ...
    //output parameters 
    //tick_current: -66850
    // sqrt_price_x64_current: 652190891266639104
    // tick_lower: -104160
    // tick_upper: -101280
    // liquidity_delta: 0
    println!("tick_current: {}", tick_current);
    println!("sqrt_price_x64_current: {}", sqrt_price_x64_current);
    println!("tick_lower: {}", tick_lower);
    println!("tick_upper: {}", tick_upper);
    println!("liquidity_delta: {}", liquidity_delta);
