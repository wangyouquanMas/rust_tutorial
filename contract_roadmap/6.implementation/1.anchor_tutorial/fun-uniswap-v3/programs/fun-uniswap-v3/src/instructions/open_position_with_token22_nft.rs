...
pub fn open_position_with_token22_nft<'a, 'b, 'c: 'info, 'info>(
    ...
    msg!("open_position_with_token22_nft11111111111222222222");
    ...
    //output tick_array_lower: CPswU2jTWgswxkSqQ4xYce9Kj8EJJrp4z2tMQzK1URfX
    msg!("tick_array_lower: {:?}", ctx.accounts.tick_array_lower.key());
    //output tick_array_upper: CPswU2jTWgswxkSqQ4xYce9Kj8EJJrp4z2tMQzK1URfX
    msg!("tick_array_upper: {:?}", ctx.accounts.tick_array_upper.key());
